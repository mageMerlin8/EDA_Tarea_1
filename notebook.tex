...
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{}Importa funciones auxiliares}
         \PY{o}{\PYZpc{}}\PY{k}{run} ordenaciones.ipynb
         \PY{o}{\PYZpc{}}\PY{k}{run} funcionesPruebas.ipynb
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{}Se define un arreglo de tamaños para las pruebas}
         \PY{n}{px} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{1000}\PY{p}{,} \PY{l+m+mi}{2000}\PY{p}{,} \PY{l+m+mi}{3000}\PY{p}{,} \PY{l+m+mi}{4000}\PY{p}{,} \PY{l+m+mi}{5000}\PY{p}{]}
         
         \PY{c+c1}{\PYZsh{}Se corren las pruebas}
         \PY{n}{resultadosInsertion} \PY{o}{=} \PY{n}{correPruebas}\PY{p}{(}\PY{n}{insertionSort}\PY{p}{,} \PY{n}{px}\PY{p}{)}
         \PY{n}{resultadosMerge} \PY{o}{=} \PY{n}{correPruebas}\PY{p}{(}\PY{n}{mergeSort}\PY{p}{,} \PY{n}{px}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{}Se checa que en efecto se hayan ordenado los arreglos}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Los arreglos ordenados por Insercion están ordenados: }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{checaResultados}\PY{p}{(}\PY{n}{resultadosInsertion}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Los arreglos ordenados por Mezcla están ordenados: }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{checaResultados}\PY{p}{(}\PY{n}{resultadosMerge}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{}Se grafican los resultados}
         \PY{n}{plotResults}\PY{p}{(}\PY{n}{resultadosInsertion}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZca{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plotResults}\PY{p}{(}\PY{n}{resultadosMerge}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{s}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
